...
# For mvrnorm to generate correlated variables
library(MASS) 
...
cov_matrix <- matrix(c(sd_tip^2, desired_correlation * sd_tip * 10, 
...
sim_data <- mvrnorm(n, mu = c(mean_tip, 50), Sigma = cov_matrix)
...
# Create rda file ###################################
#save(TipExperiment, file = "../data/TipExperiment.rda")
